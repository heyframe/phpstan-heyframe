...
namespace HeyFrame\PhpStan\Tests\Rule\BestPractise;

use PHPStan\Rules\Rule;
use HeyFrame\PhpStan\Collector\DALDefinitionCollector;
use HeyFrame\PhpStan\Collector\DALEntityCollector;
use HeyFrame\PhpStan\Rule\BestPractise\DALDefinitionRule;
...
class DALDefinitionRuleTest extends \PHPStan\Testing\RuleTestCase
{
    ...
    public function testMissingProperty(): void
    {
        $this->analyse([__DIR__ . '/fixtures/DALDefinitionRule/missing-property.php'], [
            [
                'The field "name" in the definition "foo" is not defined in the entity "HeyFrame\Tests\Rule\BestPractise\fixtures\DALDefinitionRule\FooEntity".',
                1,
            ],
        ]);
    }
